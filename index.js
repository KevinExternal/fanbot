...
case 'card':  
       argz = arg.split("|")
   if (!argz) return Haikal.reply(from, `Penggunaan ${prefix}card teks|jumlah`, kal)
    if (isNaN(argz[1])) return Haikal.reply(from, `Penggunaan ${prefix}card teks|jumlah`, kal)
  ...
  res = await Haikal.prepareMessageFromContent(from, {
					"extendedTextMessage": {
						...
						"jpegThumbnail": fs.readFileSync('./media/anjay.jpeg'),
					}
				}, {quoted: kal, contextInfo:{}}) 
 Haikal.relayWAMessage(res)
